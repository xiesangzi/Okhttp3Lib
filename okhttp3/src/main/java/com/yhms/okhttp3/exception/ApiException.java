package com.yhms.okhttp3.exception;
...
public class ApiException extends Exception {
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex = new ApiException(e, ERROR.UNKNOWN_SERVICE_EXCEPTION);
            ex.message = "无法连接服务器";
        } else if (e instanceof NetworkOnMainThreadException) {
            ex = new ApiException(e, ERROR.NETWORK_ON_MAIN_THREAD_EXCEPTION);
            ex.message = "主线中网络请求异常";
        } else {
    ...
    public static class ERROR {
         ...
         * 无法连接服务器
         */
        public static final int UNKNOWN_SERVICE_EXCEPTION = 1007;
        /**
         * 主线程异常
         */
        public static final int NETWORK_ON_MAIN_THREAD_EXCEPTION = 1008;
